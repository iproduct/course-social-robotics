...
public class SpringSecurityConfig {
    ...
    SecurityWebFilterChain configure(ServerHttpSecurity http) throws Exception {
        return http.csrf().disable()
                    .authorizeExchange()
                .pathMatchers(HttpMethod.GET, "/queue/**").permitAll()
                .pathMatchers(HttpMethod.POST, "/queue/**").permitAll()
                .pathMatchers(HttpMethod.GET, "/topic/**").permitAll()
                .pathMatchers(HttpMethod.POST, "/topic/**").permitAll()
//                    .pathMatchers(HttpMethod.DELETE, "/queue/**").hasRole("ADMIN")
