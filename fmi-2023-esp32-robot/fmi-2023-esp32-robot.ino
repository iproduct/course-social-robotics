...
void processCommand(JsonObject cmdObj, int i) {
  ...
  } else if (cmd.equals("MOVE_FORWARD")) {
...
void loop() {
  ...
  if ((moveDistance > 0 && encoderReadings.type == ENCODER && (encoderReadings.readings[0] + encoderReadings.readings[1]) * DISTANCE_PER_PULSE / 2 < moveDistance) || (moveDuration > 0 && currentTime - moveStartTime < moveDuration)) {
